...
// Temel SQL sorgusu (erkek kategorisindeki ürünler için)
...
<body>
    ...
    <nav class="navbar">
        <div class="navbar-container">
            ...
            <a href="men.php" class="nav-btn active">Erkek</a>
    ...
    <div class="main-container">
        ...
        <main class="products-section">
            <h1 class="page-title">Erkek Giyim</h1>
